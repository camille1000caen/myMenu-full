...
//	}}
	...
	@Test	
	public void RecetteCreateIngredient() {
		
		
		
		Ingredient ingredient1 = new Ingredient("poulet");
		Ingredient ingredient2 = new Ingredient("carotte");
		Ingredient ingredient3 = new Ingredient("merguez");
		...
		recettes.add(rec1);
		ingredient1.setRecettes(recettes);
		ingredient2.setRecettes(recettes);
		ingredient3.setRecettes(recettes);
		...
		ingredient2 = ingredientRepo.save(ingredient2);
		ingredient3 = ingredientRepo.save(ingredient3);
		List<Recette> recetteFind = recRepo.findAll();
		try {
			assertEquals("couscous",recetteFind.get(0).getNom());
		}finally {	
